"""
write by lzy 2022.12.31
加入预测部分，根据历史数据，仅预测收益率情况
LSTM/DBN/LR:预测准确率均为0.5附近
均值回归:0.5

TODO:检查程序，是否没有训练？
T1:1.用SGD替代adam: https://zhuanlan.zhihu.com/p/27449596
"""
...
if __name__=='__main__':
    ...
    X_train, y_train, X_test, y_test = load_data(seq_len, True)
